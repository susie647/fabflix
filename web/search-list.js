...
if(getParameterByName('star')!=null)
    star = getParameterByName('star');

jQuery.ajax({
    dataType: "json", // Setting return data type
    method: "GET", // Setting request method
    url: "form?title="+ title +"&year="+ year + "&director="+ director + "&star="+star, // Setting request url, which is mapped by StarsServlet in Stars.java
